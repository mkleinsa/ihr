...
if (!exists("example_heart_1")) {
  stop("example_heart_1 did NOT load.")
} else {
  message("example_heart_1 successfully loaded: ",
          class(example_heart_1), " with ",
          length(example_heart_1), " elements/rows (if applicable).")
}
```
